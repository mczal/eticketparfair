...
Order No. : {{$confirmation->order->no_order}} <br>
Quantity : {{$confirmation->order->quantity}} <br>
Total : Rp.{{$confirmation->total_transfer}} <br>
<br>
...
Nama : {{$confirmation->name}} <br>
No. Order : {{$confirmation->order->no_order}} <br>
Kuantitas : {{$confirmation->order->quantity}} <br>
Total : Rp.{{$confirmation->total_transfer}} <br>
<br>
